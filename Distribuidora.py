...
class sistema():
    ...
    def janela_inicio():
        sg.theme('LightBlue1')
        layout = [  [sg.Text('Bem vindo a RP Distribuidora')],
    ...
    def adicionar_pedido():
        ...
        linha_pedido = [[sg.Text('Produto 1:', size=(9,1)), sg.InputText(size=(25,0), k=('-Produto 1-')), sg.Text('Valor'), sg.InpuText(size=(10,1),k=(f'-Valor 1-')),sg.Text('Quantidade:'), sg.InputText(size=(5,1),k=('-Qtd 1-'))]]

        layout = [[sg.Text('Adicionar novo pedido')],
                  [sg.Text('Cliente:', size=(10,1)), sg.sg.InputText(size=(25,0), k='-Cliente-'), sg.button("Novo Produto")],
                  [sg.Colum(linha_pedido, key='-Column-')],
